package lk.ac.mrt.cse.dbs.simpleexpensemanager.config;
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "190478E.db";
    ...
    public static DBHelper getInstanceDB(Context context){
        if(db==null){
